...
# Default datasets for the map layer (comma-separated). Overridable per-request via ?dset=
# Available: ext (ransomware), prv (privacy), dds (DDoS), nws (news), vnd (vandalism), frm (forum)
